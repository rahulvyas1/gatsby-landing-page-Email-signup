...
import logo from "../../static/images/rankpods-logo.svg"
            ...
            <footer>
                <div className={"container"}>
                    <div className={"row"}>
                        <div className={"col-5"}>
                            <div className={"widget__item"}>
                                ...
                                <div className={"about"}>
                                    <p>An online tool that helps you rank your podcasts on Search Engines and grows with you</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className={"widget__item"}>
                                <ul className={"links"}>
                                    ...
                                    <ul>
                                        ...
                                        <li><a title={"Under Construction"}>Blog</a></li>
                                    </ul>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className={"copyright"}>
                        <p>Copyright {new Date().getFullYear()}, {` `} <a href="https://histaff.io" title={"HiStaff"}>RankPods</a>. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </>
